      ...
      $.ajax({
        ...
        success: function (data) {
          if (data.success) {
            ...
            //All step handle chat after accept contact
            //Step1 : close modal
            ...
            let leftSideData = `
            <a href="#uid_${targetId}" class="room-chat"
                                data-target="#to_${targetId}">
          ...
          <div class="right tab-pane" data-chat="${targetId}"
                        ...
                        <div class="top">
                            ...
                            <span class="chat-menu-right">
                                <a href="#attachmentsModal_${targetId}" class="show-attachments"
                                    data-toggle="modal">
                                    Tệp đính kèm
                        ...
                        <div class="write" data-chat="${targetId}">
                            ...
                            <div class="icons">
                                ...
                                <label for="attachment-chat-${targetId}">
                                    <input type="file" id="attachment-chat-${targetId}"
  ...
  let rightSideData = `
          <div class="right tab-pane" data-chat="${user.id}"
                        ...
                        <div class="top">
                            ...
                            <span class="chat-menu-right">
                                <a href="#attachmentsModal_${user.id}" class="show-attachments"
                                    data-toggle="modal">
                                    Tệp đính kèm
                                    <i class="fa fa-paperclip"></i>
                                </a>
